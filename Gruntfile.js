module.exports = function ( grunt ) {
  ...
  grunt.registerTask( 'compile', [
    'clean:compile', 'recess:compile', 'copy:compile_htaccess', 'copy:compile_php', 'copy:compile_config', 'copy:compile_assets', 'ngmin', 'concat:compile_js', 'uglify', 'index:compile'
  ]);
